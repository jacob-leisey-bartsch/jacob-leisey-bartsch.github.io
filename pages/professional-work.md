...
# VISIMO
## Agility Prime
Developed an object detection system that analyzed drone footage to identify potential collision hazards (e.g., aircraft, trees, and buildings) and built a dashboard allowing users to upload and analyze their own videos.
